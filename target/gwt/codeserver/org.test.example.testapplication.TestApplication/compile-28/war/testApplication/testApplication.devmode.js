...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.testApplication=");
    idx += (13 + "testApplication".length);  // 
  }
  if (idx >= 0) {
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/testApplication/_sourcemap.json 
//# sourceURL=testApplication-0.js
